...
import com.tlfmj.bao.sampletwo.bean.ZiXuBean;
...
public class TwoFragment extends Fragment {
    ...
    @BindView(R.id.list)
    ListView listView;
    AbsCommonAdapter<ZiXuBean> adapter;
    List<ZiXuBean> list;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.main_fragment_navigator_two, container, false);
         ButterKnife.bind(this, view);
        list = new ArrayList<>();
        adapter = new AbsCommonAdapter<ZiXuBean>(getActivity(), R.layout.list_item_zixu, list) {
            @Override
            protected void convert(AbsViewHolder holder, final ZiXuBean bean, int position) {
